...
{
    public interface IJetstreamTransport
    {
        /// <summary>
        ...
        Task<IDisposable> SubscribeAsync(string stream, string topic, Func<byte[], Task> handler,
        ...
        /// <param name="cancellationToken"></param>
        Task PublishAsync(string stream, string topic, byte[] message, CancellationToken cancellationToken = default);
    }
}